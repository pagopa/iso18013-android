package it.pagopa.io.wallet.proximity.nfc.response

import com.android.identity.util.toHex
import it.pagopa.io.wallet.proximity.nfc.apdu.ByteDataReader
import it.pagopa.io.wallet.proximity.nfc.apdu.appendByteString
import it.pagopa.io.wallet.proximity.nfc.apdu.appendUInt8
...
data class ResponseApdu(
    ...
    val isFinalResponse: Boolean = false
) {
    /**
